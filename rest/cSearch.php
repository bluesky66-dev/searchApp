...
class GoogleCustomSearch
{
     ...
     **/
    public function search($terms, $page, $per_page, $extra=[])
    {
  ...
  //print_r($extra);
        ...
        //$result->excludeTerms = $request_info->excludeTerms;
        $results = new \stdClass();
        $results->q = $terms;
        $results->excludeTerms = $request_info->excludeTerms;
        $results->exactTerms = $request_info->exactTerms;
        $results->dateRestrict = $request_info->dateRestrict;
        $results->page = $page;
